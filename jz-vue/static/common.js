...
function showLoading() {
    var loadTpl = '<div class="loader"><div class="loader-inner ball-clip-rotate"><div></div></div></div>';
    if ($('body').find('.loader_popover').length <= 0) $('body').append(loadTpl);
}

function hideLoading() {
    $('.loader_popover').remove();
}